      ...
      <div className="grid grid-cols-1 lg:grid-cols-[300px_1fr] gap-4 p-4">
        ...
        <div className="space-y-4">
          ...
          >
            ...
            <h3 className="mb-2 text-lg font-medium">Available Routes</h3>
            <div className="space-y-2">
              {availableRoutes.map((route) => (
                <div key={route.id} className="pb-2 border-b border-blue-900/30 last:border-0">
          ...
          >
            ...
            <h3 className="mb-2 text-lg font-medium">Weekly Weather</h3>
            <div className="space-y-2">
              {weatherData.map((day, index) => (
                <div key={index} className="pb-2 border-b border-blue-900/30 last:border-0">
                  <div className="flex items-center justify-between">
            ...
            <div className="mt-4 text-right">
              <Button variant="ghost" className="flex items-center gap-1 text-blue-400 transition-colors hover:text-blue-300">
                View all <ChevronRight className="w-4 h-4" />
              </Button>
            </div>
          </motion.div>
        ...
        >
          <div className="h-[calc(100vh-8rem)] w-full relative">
            ...
            <div className="absolute top-4 left-4 z-[1000] bg-[#0D2137]/80 backdrop-blur-md p-3 rounded-lg border border-blue-900/30">
              <h3 className="mb-2 text-sm font-medium">Route Information</h3>
              {sourceCoordinates && destinationCoordinates ? (
                <div className="space-y-1 text-sm">
                  <div className="flex items-center gap-2">
                    <Badge variant="outline" className="text-blue-300 bg-blue-500/20 border-blue-500/50">
        ...
        <DialogContent className="bg-[#0D2137] border border-blue-900/30 text-white max-w-md">
          ...
          <form onSubmit={handleSubmit} className="mt-4 space-y-4">
            <div className="space-y-2">
              ...
              <div className="relative">
                <MapPin className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400\" size={18}                <MapPin className="absolute text-gray-400 transform -translate-y-1/2 left-3 top-1/2" size={18} />
                <input
                  type="text"
                  name="source"
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <PackageIcon className="absolute text-gray-400 transform -translate-y-1/2 left-3 top-1/2" size={18} />
                <input
                  type="number"
                  name="weight"
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <DollarSign className="absolute text-gray-400 transform -translate-y-1/2 left-3 top-1/2" size={18} />
                <input
                  type="number"
                  name="budget"
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Clock className="absolute text-gray-400 transform -translate-y-1/2 left-3 top-1/2" size={18} />
                <input
                  type="number"
                  name="timeline"
