  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        >
          <h2 className="mb-6 text-xl font-semibold">Find Optimal Route</h2>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full px-4 py-2 text-white transition-colors bg-blue-600 rounded-lg hover:bg-blue-700 disabled:opacity-50"
              disabled={isLoading}
            >
        ...
        <motion.div
          ...
          className="bg-[#0D2137] p-6 rounded-xl"
        >
          <h2 className="mb-6 text-xl font-semibold">Route Information</h2>
          {sourceCoordinates && destinationCoordinates ? (
            <div className="space-y-4">
              <div className="bg-[#162B44] p-4 rounded-lg">
                <h3 className="mb-2 font-medium text-gray-300">Distance</h3>
              ...
              <div className="bg-[#162B44] p-4 rounded-lg">
                <h3 className="mb-2 font-medium text-gray-300">Estimated Cost</h3>
              ...
              <div className="bg-[#162B44] p-4 rounded-lg">
                <h3 className="mb-2 font-medium text-gray-300">Estimated Duration</h3>
                <p className="text-2xl font-bold">
              ...
              <div className="bg-[#162B44] p-4 rounded-lg">
                <h3 className="mb-2 font-medium text-gray-300">Transportation Type</h3>
      ...
      <motion.div
        ...
        className="bg-[#0D2137] p-6 rounded-xl"
      >
        <h2 className="mb-6 text-xl font-semibold">Real-time Route Map</h2>
